            ...
            <div class="col-sm-12">
                <div class="panel"  style="padding: 10px;">
                    <div class="panel-header">
                        <h2>Компании</h2>
                        <a class="btn btn-success btn-sm" href="{{route('company.create')}}">Добавить</a>
                    </div>
                                ...
                                @foreach($companies as $company)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <button type="button" class="btn btn-danger btn-xs mr-1" data-toggle="modal" data-target="#exampleModal{{$company->id}}">
                                                Удалить
                                            </button>
                                            ...
                                            <a href="{{route('company.edit' ,['id'=>$company->id ])}}" class="btn-xs btn btn-primary">Изменить</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
